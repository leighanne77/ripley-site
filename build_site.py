...
<p>A decade-plus in tech as an AI/ML engineer, most recently Google&nbsp;X. She started as a
...
volunteers with the Office of Net Assessment on AI-enabled scenario-based planning, and is
affiliated with the Institute for State Effectiveness in Washington,&nbsp;D.C.</p>
