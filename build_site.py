...
<p class="srcnote">Every dollar cell reads TBD by design. The site intake is unsourced, and no
figure enters an EGON payload before a source that contains it is cited. ROI is avoided loss
divided by spend over the hold. Committed and underway public work is screened out as baseline,
never re-proposed as an opportunity.</p>
